...
public class SUPPLIER implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        ...
        b.add("S_SUPPKEY", typeFactory.createJavaType(Integer.class));
        b.add("S_NAME", typeFactory.createJavaType(String.class));
        b.add("S_ADDRESS", typeFactory.createJavaType(String.class));
        b.add("S_NATIONKEY", typeFactory.createJavaType(Integer.class));
        b.add("S_PHONE", typeFactory.createJavaType(String.class));
        b.add("S_ACCTBAL", typeFactory.createJavaType(Double.class));
        b.add("S_COMMENT", typeFactory.createJavaType(String.class));
        return b.build();
    }
    @Override
