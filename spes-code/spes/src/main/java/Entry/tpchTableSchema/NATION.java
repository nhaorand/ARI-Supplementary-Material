...
public class NATION implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        RelDataTypeFactory.FieldInfoBuilder b = typeFactory.builder();
        b.add("N_NATIONKEY", typeFactory.createJavaType(Integer.class));
        b.add("N_NAME", typeFactory.createJavaType(String.class));
        b.add("N_REGIONKEY", typeFactory.createJavaType(Integer.class));
        b.add("N_COMMENT", typeFactory.createJavaType(String.class));
        return b.build();
    }
    @Override
