...
public class PARTSUPP implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        RelDataTypeFactory.FieldInfoBuilder b = typeFactory.builder();
        b.add("PS_PARTKEY", typeFactory.createJavaType(Integer.class));
        b.add("PS_SUPPKEY", typeFactory.createJavaType(Integer.class));
        b.add("PS_AVAILQTY", typeFactory.createJavaType(Integer.class));
        b.add("PS_SUPPLYCOST", typeFactory.createJavaType(Double.class));
        b.add("PS_COMMENT", typeFactory.createJavaType(String.class));
        return b.build();
    }
    @Override
