...
public class REGION implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        ...
        b.add("R_REGIONKEY", typeFactory.createJavaType(Integer.class));
        b.add("R_NAME", typeFactory.createJavaType(String.class));
        b.add("R_COMMENT", typeFactory.createJavaType(String.class));
        return b.build();
    }
    @Override
