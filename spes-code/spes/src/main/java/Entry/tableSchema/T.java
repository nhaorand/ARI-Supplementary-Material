...
public class T implements Table{
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        ...
        b.add("K0", typeFactory.createJavaType(String.class));
        b.add("C1", typeFactory.createJavaType(String.class));
        b.add("F1_A0", typeFactory.createJavaType(Integer.class));
        b.add("F2_A0", typeFactory.createJavaType(Byte.class));
        b.add("F0_C0", typeFactory.createJavaType(Integer.class));
        b.add("F1_C0", typeFactory.createJavaType(Integer.class));
        b.add("F0_C1", typeFactory.createJavaType(Integer.class));
        b.add("F1_C2", typeFactory.createJavaType(Integer.class));
        b.add("F2_C3", typeFactory.createJavaType(Integer.class));
        return b.build();
    }
    @Override
