...
public class HISTORY implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        RelDataTypeFactory.FieldInfoBuilder b = typeFactory.builder();
        b.add("H_C_ID", typeFactory.createJavaType(Integer.class));
        b.add("H_C_D_ID", typeFactory.createJavaType(Integer.class));
        b.add("H_C_W_ID", typeFactory.createJavaType(Integer.class));
        b.add("H_D_ID", typeFactory.createJavaType(Integer.class));
        b.add("H_W_ID", typeFactory.createJavaType(Integer.class));
        b.add("H_DATE", typeFactory.createJavaType(String.class)); //timestamp
        b.add("H_AMOUNT", typeFactory.createJavaType(Double.class));
        b.add("H_DATA", typeFactory.createJavaType(String.class));
        return b.build();
    }
    @Override
