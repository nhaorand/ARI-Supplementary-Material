...
public class ITEM implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        RelDataTypeFactory.FieldInfoBuilder b = typeFactory.builder();
        b.add("I_ID", typeFactory.createJavaType(Integer.class));
        b.add("I_NAME", typeFactory.createJavaType(String.class));
        b.add("I_PRICE", typeFactory.createJavaType(Double.class));
        b.add("I_DATA", typeFactory.createJavaType(String.class));
        b.add("I_IM_ID", typeFactory.createJavaType(Integer.class));
        return b.build();
    }
    @Override
