...
public class NEW_ORDER implements Table {
    public RelDataType getRowType(RelDataTypeFactory typeFactory) {
        RelDataTypeFactory.FieldInfoBuilder b = typeFactory.builder();
        b.add("NO_W_ID", typeFactory.createJavaType(Integer.class));
        b.add("NO_D_ID", typeFactory.createJavaType(Integer.class));
        b.add("NO_O_ID", typeFactory.createJavaType(Integer.class));
        return b.build();
    }
    @Override
